...
document.addEventListener("DOMContentLoaded", (event) => {
    ...
    blogListDiv.innerHTML = '<section id="sectionID">
        <div class="spildy-blog-listing blog-listing-v3">
            <div class="blog-listing-bg blog-listing-tb-space">
                <div class="spildy-container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-6" id="blogRepeat">
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-8 col-lg-8 p-0">
                                        <div class="blog-listing-info">
                                            ...
                                            <div class="description mb-3">If you\'re considering starting a small textile business, you\'re in the right place. Whether you want to become fabric suppliers for small businesses or start your own cloth manufacturing company, there are some key steps you need to take to...</div>
                                            <div class="name">By Username, LowCode- Jun 6, 2024</div>
                                        </div>
                                    </div>
                                </div>                       
                            </div>                            
                        </div><div class="col-12 col-sm-12 col-md-12 col-lg-6" id="blogRepeat">
                            <div class="blog-listing-box">
                                <div class="row m-0">
                                    <div class="col-12 col-sm-4 col-md-4 col-lg-4 p-0">
                                        <div class="blog-listing-img">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-8 col-lg-8 p-0">
                                        <div class="blog-listing-info">
                                            ...
                                            <div class="description mb-3">Are you on the hunt for a new gym to join? With so many options available, it can be overwhelming to choose the right one. Whether you\'re looking for gyms near me or specific features like a sauna or childcare,...</div>
                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-12 col-sm-8 col-md-8 col-lg-8 p-0">
                                        <div class="blog-listing-info">
                                            ...
                                            <div class="description mb-3">Investing in crypto currency can be a lucrative endeavor, but it also comes with its own set of risks. The digital assets market is known for being volatile, with prices fluctuating wildly in a short period of time. This makes...</div>
